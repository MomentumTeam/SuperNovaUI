...
export const TableTypes = {
  entities: [
    ...
    {
      field: ['personalNumber', 'identityCard'],
      displayName: 'מ"א/ת"ז',
  ...
  hierarchy: [
    {
      field: ['hierarchy', 'name'],
      displayName: 'היררכיה',
      formatter: concatHierarchy,
    },
    ...
    entities: [
      {
        ...
        searchField: 'id',
        searchDisplayName: userStore.isUserExternal
          ? 'שם/מ"א/ת"ז/מזהה עובד'
          : 'שם/מ"א/ת"ז',
