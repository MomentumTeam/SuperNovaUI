    ...
    return (
        <div className="search-item">
            <div className="autocomplete-wrap">
                <div className="p-fluid">
                    <span className="p-float-label">
                        <AutoComplete value={selectedCountry1} suggestions={filteredResults} completeMethod={search} field="name" onChange={(e) => setSelectedCountry1(e.value)} />
            ...
            <div className="autocomplete-wrap">
                <div className="p-fluid">
                    <span className="p-float-label">
                        <AutoComplete value={selectedResults} suggestions={filteredResults} completeMethod={search} field="name" multiple onChange={(e) => setSelectedResults(e.value)} />
            ...
            <div className="autocomplete-wrap">
                <div className="p-fluid">
                    <span className="p-float-label">
                        <AutoComplete value={role} suggestions={filteredResults} completeMethod={search} field="name" onChange={(e) => setRole(e.value)} />
