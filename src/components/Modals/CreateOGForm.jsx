        ...
        <div className="p-fluid">
            ...
            <div className="p-fluid-item">
                <div className="p-field">
                    <label htmlFor="2021"><span className="required-field">*</span>שם היררכיה חדשה</label>
                    <InputText {...register("newHierarchy")} id="2021" type="text" required placeholder="שם היררכיה חדשה" />
                </div>
            </div>
            <div className="p-fluid-item">
