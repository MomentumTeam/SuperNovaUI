            ...
            <div className="row3flex">
                ...
                <div className="p-fluid-item">
                    <div className="p-field">
                        ...
                        <InputText {...register("personalNumber")} id="2021" type="text" required placeholder="מ''א/ת''ז" />
                    </div>
                </div>
                <div className="p-fluid-item">
            ...
            <div className="row3flex">
                <div className="p-fluid-item ">
                    <div className="p-field p-field-blue">
                        ...
                        <Dropdown {...register("roleName")} inputId="2025" options={states} placeholder="שם תפקיד" optionLabel="name" />
                    </div>
                </div>
                <div className="p-fluid-item">
                    <div className="p-field">
