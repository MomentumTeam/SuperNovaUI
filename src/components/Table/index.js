...
class Table extends React.Component {
    constructor(props) {
        ...
        this.classificationBodyTemplate = this.classificationBodyTemplate.bind(this);
    ...
    classificationBodyTemplate(rowData) {
        return (
            <React.Fragment>
                ...
                <span className={classNames('customer-badge', 'status-' + rowData.classification)}>{rowData.classification}</span>
            </React.Fragment>
        );
    }
                ...
                <div className="tableStyle" >
                    <div className="card">
                        <DataTable value={this.props.data} scrollable
                            ...
                            <Column field="classification" header="סיווג" body={this.classificationBodyTemplate} sortable></Column>
